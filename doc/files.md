...
* bitcoin.conf: contains configuration settings for dogechaind or bitcoin-qt
* dogechaind.pid: stores the process id of dogechaind while running
...
* debug.log: contains debug information and general logging generated by dogechaind or bitcoin-qt
