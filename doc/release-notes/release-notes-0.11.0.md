...
- #5809 `46bfbe7` Add dogechain-cli man page
...
- #5849 `41259ca` contrib/init/dogechaind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for dogechain-tx)
