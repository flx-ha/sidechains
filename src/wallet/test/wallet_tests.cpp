...
BOOST_FIXTURE_TEST_CASE(rescan, DogeChain100Setup)
{
    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see dogechaind log for details) and could be dealt with by "
...
BOOST_FIXTURE_TEST_CASE(importwallet_rescan, DogeChain100Setup)
{
    // TODO Make this test work without block subsidy
    /*
...
// debit functions.
BOOST_FIXTURE_TEST_CASE(coin_mark_dirty_immature_credit, DogeChain100Setup)
{
    // TODO Make this test work without block subsidy
    /*
    CWallet wallet;
...
class ListCoinsTestingSetup : public DogeChain100Setup
{
public:
