...
const char * const BITCOIN_CONF_FILENAME = "dogechain.conf";
const char * const BITCOIN_PID_FILENAME = "dogechaind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DogeChain";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DogeChain";
#else
    // Unix
    return pathRet / ".dogechain";
#endif
#endif
}
